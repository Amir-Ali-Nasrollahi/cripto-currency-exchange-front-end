<template>
    <section class="w-full h-full">
        <div class="h-full w-full">
            <div
                class="h-full flex flex-col justify-between py-8 items-center bg-gradient-to-b from-orange-400 to-amber-400">
                <div class="h-full w-full flex flex-col items-center">
                    ...
                    <ul class="h-1/2 flex flex-col items-start justify-around">
                        ...
                        <li class="p-3 hover:cursor-pointer transition-all duration-50 ease-linear rounded-2xl hover:bg-orange-100"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="size-6">
                                <path stroke-linecap="round" stroke-linejoin="round"
